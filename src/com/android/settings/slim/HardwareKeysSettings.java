...
public class HardwareKeysSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_DISABLE_HW_KEYS = "disable_hw_keys";
    ...
    private PreferenceScreen reloadSettings() {
        ...
        mDisableHwKeys = (SwitchPreference) findPreference(KEY_DISABLE_HW_KEYS);
        mDisableHwKeys.setOnPreferenceClickListener(this);
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (preference == mDisableHwKeys) {
            writeDisableHwKeys(getActivity(), mDisableHwKeys.isChecked());
            return true;
        }
