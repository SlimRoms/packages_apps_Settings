...
public class NxSettings extends ActionFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNxTrailsEnable.setChecked(Settings.System.getIntForUser(getContentResolver(),
                "nx_trails_enabled", 0, UserHandle.USER_CURRENT) == 1);
        mNxTrailsEnable.setOnPreferenceChangeListener(this);

        mShowLogo = (SwitchPreference) findPreference("nx_show_logo");
        mShowLogo.setChecked(Settings.System.getIntForUser(getContentResolver(),
        ...
        mAnimateLogo.setChecked(Settings.System.getIntForUser(getContentResolver(),
        ...
        mShowRipple.setChecked(Settings.System.getIntForUser(getContentResolver(),
