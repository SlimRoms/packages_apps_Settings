...
public class StatusBar extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatteryStyle = SlimSettings.System.getInt(resolver,
                SlimSettings.System.STATUS_BAR_BATTERY_STYLE, 0);
        mStatusBarBattery.setValue(String.valueOf(mBatteryStyle));
        mStatusBarBattery.setSummary(mStatusBarBattery.getEntry());
        mStatusBarBattery.setOnPreferenceChangeListener(this);

        mBatteryShowPercent = SlimSettings.System.getInt(resolver,
                SlimSettings.System.STATUS_BAR_SHOW_BATTERY_PERCENT, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mStatusBarBattery) {
            ...
            SlimSettings.System.putInt(
                    resolver, SlimSettings.System.STATUS_BAR_BATTERY_STYLE, mBatteryStyle);
            ...
            SlimSettings.System.putInt(resolver,
                    SlimSettings.System.STATUS_BAR_SHOW_BATTERY_PERCENT, mBatteryShowPercent);
