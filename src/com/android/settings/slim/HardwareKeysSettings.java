...
public class HardwareKeysSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sFinalActionDialogArray = DeviceUtils.filterUnsupportedDeviceFeatures(getActivity(),
            res.getStringArray(res.getIdentifier(
                    "org.slim.framework.internal.shortcut_action_hwkey_values", "array", "com.android.settings")),
            res.getStringArray(res.getIdentifier(
                    "org.slim.framework.internal.shortcut_action_hwkey_entries", "array", "com.android.settings")));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEnableCustomBindings) {
            ...
            SlimSettings.System.putInt(getContentResolver(), SlimSettings.System.HARDWARE_KEY_REBINDING,
                    value ? 1 : 0);
            return true;
        }
        return false;
