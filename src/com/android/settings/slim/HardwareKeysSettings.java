...
public class HardwareKeysSettings extends SettingsPreferenceFragment implements
    ...
    private PreferenceScreen reloadSettings() {
        ...
        if (hasCameraKey) {
            ...
            setupOrUpdatePreference(mCameraPressAction,
                    ...
                    Slim.Settings.System.KEY_CAMERA_ACTION);
            ...
            setupOrUpdatePreference(mCameraLongPressAction,
                    ...
                    Slim.Settings.System.KEY_CAMERA_LONG_PRESS_ACTION);
            ...
            setupOrUpdatePreference(mCameraDoubleTapAction,
                    ...
                    Slim.Settings.System.KEY_CAMERA_DOUBLE_TAP_ACTION);
        } else {
        ...
        if (hasAssistKey) {
            ...
            setupOrUpdatePreference(mAssistPressAction,
                    ...
                    Slim.Settings.System.KEY_ASSIST_ACTION);
            ...
            setupOrUpdatePreference(mAssistLongPressAction,
                    ...
                    Slim.Settings.System.KEY_ASSIST_LONG_PRESS_ACTION);
            ...
            setupOrUpdatePreference(mAssistDoubleTapAction,
                    ...
                    Slim.Settings.System.KEY_ASSIST_DOUBLE_TAP_ACTION);
        } else {
        ...
        if (hasAppSwitchKey) {
            ...
            setupOrUpdatePreference(mAppSwitchPressAction,
                    ...
                    Slim.Settings.System.KEY_APP_SWITCH_ACTION);
            ...
            setupOrUpdatePreference(mAppSwitchLongPressAction,
                    ...
                    Slim.Settings.System.KEY_APP_SWITCH_LONG_PRESS_ACTION);
            ...
            setupOrUpdatePreference(mAppSwitchDoubleTapAction,
                    ...
                    Slim.Settings.System.KEY_APP_SWITCH_DOUBLE_TAP_ACTION);
        } else {
            prefs.removePreference(keysAppSwitchCategory);
        }

        boolean enableHardwareRebind = Slim.Settings.System.getInt(getContentResolver(),
                Slim.Settings.System.HARDWARE_KEY_REBINDING, 0) == 1;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEnableCustomBindings) {
            ...
            Slim.Settings.System.putInt(getContentResolver(), Slim.Settings.System.HARDWARE_KEY_REBINDING,
                    value ? 1 : 0);
            return true;
        }
        return false;
    ...
    private void resetToDefault() {
        ...
        Slim.Settings.System.putInt(getContentResolver(),
    ...
    public void shortcutPicked(String action,
        ...
        Slim.Settings.System.putString(getContentResolver(), mPendingSettingsKey, action);
        reloadSettings();
                    ...
                    .setItems(getOwner().sFinalActionDialogArray.entries,
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (getOwner().sFinalActionDialogArray.values[item]
                                ...
                                Slim.Settings.System.putString(getActivity().getContentResolver(),
                                        settingsKey,
